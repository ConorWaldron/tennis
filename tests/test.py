...
def test_team_played_before(valid_team_4, reg_team_4_wrong_order, team_4_same_as_week2_wrong_order,
                            team_4_df, team_4_subs_and_lower_class_df, prev_week1, prev_week2):
    """
    Checks that
    ...
    """
    expected_value = True, None
    actual_value = team_played_before(valid_team_4, team_4_df, team_4_subs_and_lower_class_df, prev_week2)
    assert expected_value == actual_value
    ...
    actual_value = team_played_before(reg_team_4_wrong_order, team_4_df, team_4_subs_and_lower_class_df, prev_week2)
    assert expected_value == actual_value
    ...
    actual_value = team_played_before(team_4_same_as_week2_wrong_order, team_4_df, team_4_subs_and_lower_class_df, prev_week2)
    assert expected_value == actual_value
...
def test_singles_right_order(valid_team_4, team_4_singles_out_order, team_4_singles_out_order_class, team_4_singles_out_order_team,
                             team_4_df, team_4_subs_and_lower_class_df, prev_week2):
    """
    Checks that
    ...
    """
    expected_value = True, None
    actual_value = singles_right_order(valid_team_4, team_4_df, team_4_subs_and_lower_class_df, prev_week2)
    assert expected_value == actual_value

    expected_value = False, 'You are playing Shane Bergin ahead of Conor Waldron but that violates a previous weeks order'
    actual_value = singles_right_order(team_4_singles_out_order, team_4_df, team_4_subs_and_lower_class_df, prev_week2)
    assert expected_value == actual_value

    expected_value = False, 'You are playing Brian Masterson (class 5) ahead of Conor Waldron (class 4)'
    actual_value = singles_right_order(team_4_singles_out_order_class, team_4_df, team_4_subs_and_lower_class_df, prev_week2)
    assert expected_value == actual_value

    expected_value = False, 'You are playing James Fagan (team 5) ahead of Conor Waldron (team 4)'
    actual_value = singles_right_order(team_4_singles_out_order_team, team_4_df, team_4_subs_and_lower_class_df, prev_week2)
    assert expected_value == actual_value
...
def test_doubles_right_order(valid_team_4, team_3_invalid_doubles_order, team_2_invalid_doubles_order,
                             team_4_df, team_4_subs_and_lower_class_df, prev_week2,
                             team_3_df, team_3_subs_and_lower_class_df,
                             team_2_df, team_2_subs_and_lower_class_df):
    """
    Checks that
...
# @pytest.mark.skip
def test_team_tied(valid_team_4, valid_team_7, invalid_team_7_team_tied, prev_week2, prev_week3,
                   team_4_df, team_4_subs_and_lower_class_df,
                   team_7_df, team_7_subs_and_lower_class_df):
    expected_value = True, None
    actual_value = team_tied(valid_team_4, team_4_df, team_4_subs_and_lower_class_df, prev_week2)
    assert expected_value == actual_value

    expected_value = True, None
    actual_value = team_tied(valid_team_7, team_7_df, team_7_subs_and_lower_class_df, prev_week2)
    assert expected_value == actual_value

    expected_value = False, 'Kabir Kalia is inelgiible due to team tying, he has played for a higher team on 2 occasions'
    actual_value = team_tied(valid_team_7, team_7_df, team_7_subs_and_lower_class_df, prev_week3)
    assert expected_value == actual_value

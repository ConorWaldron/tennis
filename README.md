...
'docker build -t conorwaldron512/summer_league_webapp:1.2 .' where the :1.2 indicates its version 1.2
...
'docker run -d -p 8888:5000 conorwaldron512/summer_league_webapp:1.2'

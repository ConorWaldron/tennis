...
'docker run -d -p 8888:5000 conorwaldron512/summer_league_webapp:1.1'
...
If you want to publish your docker file to dockerhub you can use 'docker push conorwaldron512/summer_league_webapp:1.1' or 'docker push conorwaldron512/winter_league_webapp:1.0' and then you can see the file on the docker hub wesbite at https://hub.docker.com/

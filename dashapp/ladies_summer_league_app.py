...
reg_team = pd.read_csv('../assets/summer_league/ladies_teams.csv')
reg_team_relevant = reg_team[['Team', 'Position', 'Name']]
reg_team_relevant = reg_team_relevant.rename(columns={'Name': 'Registered'})

reg_subs = pd.read_csv('../assets/summer_league/ladies_subs.csv')

prev_weeks = pd.read_csv('../assets/summer_league/ladies_previous_weeks.csv')
